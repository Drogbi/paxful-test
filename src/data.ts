    ...
    trades: [
        {
            ...
            messages: [{ author: { id: 1, name: 'Alex', avatarUrl: 'https://i.pravatar.cc/150?img=2' }, content: 'Hello', datetime: new Date().toDateString() }],
        ...
        },
        {
            ...
            messages: [
                ...
                {
                    author: { id: 3, name: 'Alex', avatarUrl: 'https://i.pravatar.cc/150?img=2' },
